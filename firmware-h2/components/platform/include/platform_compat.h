...
//
// Lets logic components compile both on ESP-IDF targets and in plain host unit
// tests. It provides three things:
...
//
// NOTE: byte-identical copy of firmware-c6/components/platform/. Each firmware
// project keeps its own copy (same stance as the shared uart_bridge_protocol.h).
// =============================================================================
...
// high-priority tasks never block indefinitely (RT-02).
...
// esp_err_t and the subset of codes used. Values mirror ESP-IDF's esp_err.h.
